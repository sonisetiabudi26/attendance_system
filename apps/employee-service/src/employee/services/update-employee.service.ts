...
import { EMPLOYEE_LOCATION_REPOSITORY, EMPLOYEE_REPOSITORY, LOCATION_REPOSITORY, POSITION_REPOSITORY } from "../constants/employee.constant";
import type { IEmployeeLocationRepository, IEmployeeRepository, ILocationRepository, IPositionRepository } from "../repositories";
...
export class UpdateEmployeeService {
    ...
    async execute(
        ...
        if (
            locations.length !== contract.locationIds.length
        ) {
